...
<?php
	function Pacific_Full_Listing_Time_Zone()
							{
// VAR as CONSTANT
								$File_To_Open = PACIFIC_FILE_TO_OPEN_CSV;
								$Zise = PACIFIC_SIZE_FILE_CSV;
								$Delimiter = PACIFIC_DELIMITER_CSV;
								$Enclosure = PACIFIC_ENCLOSURE_CSV;
								$Escape = PACIFIC_ESCAPE_CSV;
