...
<?php
	function ASIA_Full_Listing_Time_Zone()
							{
// VAR as CONSTANT
								$File_To_Open = ASIA_FILE_TO_OPEN_CSV;
								$Zise = ASIA_SIZE_FILE_CSV;
								$Delimiter = ASIA_DELIMITER_CSV;
								$Enclosure = ASIA_ENCLOSURE_CSV;
								$Escape = ASIA_ESCAPE_CSV;
