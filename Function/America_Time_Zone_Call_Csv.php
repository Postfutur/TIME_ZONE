...
<?php
	function America_Full_Listing_Time_Zone()
							{
// VAR as CONSTANT
								$File_To_Open = AMERICA_FILE_TO_OPEN_CSV;
								$Zise = AMERICA_SIZE_FILE_CSV;
								$Delimiter = AMERICA_DELIMITER_CSV;
								$Enclosure = AMERICA_ENCLOSURE_CSV;
								$Escape = AMERICA_ESCAPE_CSV;
